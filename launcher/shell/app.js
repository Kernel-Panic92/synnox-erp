...
async function showLauncher() {
  ...
  if (user?.rol === 'admin') {
    ...
    document.getElementById('commits-widget').style.display = 'none';
    document.getElementById('weather-widget').style.display = 'none';
    document.getElementById('activity-widget').style.display = 'none';
    ...
    if (user?.rol === 'gerente') {
      ...
      // Operador: solo modulos y quick actions
      cargarQuickActions();
      ...
      document.getElementById('upcoming-widget').style.display = 'none';
    }
  }
